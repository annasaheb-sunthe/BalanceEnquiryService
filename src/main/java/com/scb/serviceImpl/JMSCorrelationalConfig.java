...
public class JMSCorrelationalConfig {
	...
	public BalanceEnquiry send(BalanceEnquiry customerRequestData) {
		...
		BalanceEnquiry responseMessage =   (BalanceEnquiry) jmsTemplate.receiveSelectedAndConvert(propertiesConfig.getJmsResponseQueue(), resSelectorId);
